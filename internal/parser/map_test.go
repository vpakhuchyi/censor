				...
				Values: []models.KV{
					{Key: models.Value{Value: "key1", Kind: reflect.String}, Value: models.Value{Value: models.Struct{
						...
						Fields: []models.Field{
							...
							{Name: "Zip", Value: models.Value{Value: "55501", Kind: reflect.String}, Opts: options.FieldOptions{Display: false}}}}, Kind: reflect.Struct},
						SortValue: "key1",
					},
					...
					{Key: models.Value{Value: "key2", Kind: reflect.String}, Value: models.Value{Value: models.Struct{
						Name: "parser.address",
						Fields: []models.Field{
							{Name: "City", Value: models.Value{Value: "Denver", Kind: reflect.String}, Opts: options.FieldOptions{Display: true}},
							{Name: "State", Value: models.Value{Value: "DN", Kind: reflect.String}, Opts: options.FieldOptions{Display: true}},
							{Name: "Street", Value: models.Value{Value: "65 Best St", Kind: reflect.String}, Opts: options.FieldOptions{Display: false}},
							{Name: "Zip", Value: models.Value{Value: "55502", Kind: reflect.String}, Opts: options.FieldOptions{Display: false}}}}, Kind: reflect.Struct},
						SortValue: "key2",
					},
				},
			}
						...
						Value: models.Ptr{
							...
							Value: models.Struct{
								...
								Fields: []models.Field{
									...
									{Name: "State", Value: models.Value{Value: "DN", Kind: reflect.String}, Opts: options.FieldOptions{Display: true}},
									{Name: "Street", Value: models.Value{Value: "65 Best St", Kind: reflect.String}, Opts: options.FieldOptions{Display: false}},
									{Name: "Zip", Value: models.Value{Value: "55502", Kind: reflect.String}, Opts: options.FieldOptions{Display: false}},
								},
							},
						},
						Kind: reflect.Pointer},
